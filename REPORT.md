...
`2_Column_Inspection.ipynb` is the exploratory notebook in which the substitutions were
...
| File | Role |
|---|---|
| `2_Column_Inspection.ipynb` | Column-level inspection of `train.csv` (unique values, null counts) — how the undocumented category codes were identified (§1.2) |
